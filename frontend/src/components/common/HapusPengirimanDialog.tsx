...
import type { ManualShipment } from "@/services/manualShippingService";

export type DeletePengirimanDialogProps = {
...
export default function DeletePengirimanDialog({
  shipment,
  isDeleting = false,
  onCancel,
  onConfirm,
}: DeletePengirimanDialogProps) {
  if (!shipment) {
    return null;
  }
  ...
  return createPortal(
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="delete-pengiriman-title"
    >
      <div className="w-full max-w-md rounded-2xl bg-white shadow-2xl">
        ...
        <div className="flex items-center justify-end gap-3 border-t border-slate-200 px-6 py-4">
          ...
          <button
            ...
            onClick={onConfirm}
            disabled={isDeleting}
            aria-label="Konfirmasi hapus pengiriman"
